...
import toast_success from "../../../public/icons/toast.success.svg";
import toast_error from "../../../public/icons/toast.error.svg";
import toast_warn from "../../../public/icons/toast.warn.svg";
      ...
      className={`
            ${
              type === "success"
                ...
                p-4 md:w-[40%] w-full rounded-md shadow-md shadow-gray-600 border-l-[1.4rem] border-y-[1px] border-r-[1px] absolute z-[9999999999] translate-y-0 opacity-100 ${
