...
import Min_and_Max_icon from "./Min_and_Max_icon";
      ...
      <div className="mx-5 flex flex-wrap gap-10">
        <div className="mt-3 w-[25rem]">
          ...
          <div className="flex gap-3 items-center my-5 cursor-pointer">
            {isLoading ? (<Skeleton circle width={50} height={50}/>):(
            <Image
        ...
        <div className="mt-3 w-[25rem]">
          ...
          <div className="flex gap-3 border-l-2 border-sirp-keynotebg pl-10 items-center my-5">
            <div className="w-12">
                {isLoading ? (<Skeleton width={50} height={50} circle/>):(<ProgressBar  />)}
            </div>
            <div>
              <p className="font-bold">
                {isLoading ? (<Skeleton width={150}/>):(`${confidence}% Confidence Level`)}
              </p>
              {isLoading ? (<Skeleton width={150}/>):(<p className="text-sirp-primary2 text-xs rounded-[1rem] border text-center w-[8rem]">
                Review confidence
              </p>)}
            </div>
          </div>
        ...
        <div className="w-[25rem]">
          ...
          <div className="flex gap-3 items-center mt-3">
            {isLoading ? (<Skeleton width={50} height={50} circle/>):(
                <Image
